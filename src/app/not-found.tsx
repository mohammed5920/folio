...
export default function Loading() {
  return (
    <div className="w-screen h-screen flex items-center justify-center">
      <Link
        href={"/"}
        className="p-8 pt-4.5 border border-white/10 rounded-2xl hover:bg-white/10 hover:shadow-sm shadow-white/10 transition-colors text-4xl sm:text-5xl font-serif italic tracking-tighter leading-[0.85]"
      >
